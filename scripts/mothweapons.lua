...
function build(directory, config, parameters, level, seed)
	...
	if ((not (parameters.localisation)) or (not (parameters.localisation == language))) then
		...
		if parameters.entryshortdescription and parameters.entrydescription then
			parameters.category = getTranslatedMiscellaneous(language, parameters.entrycategory)
			parameters.shortdescription = getTranslatedMiscellaneous(language, parameters.entryshortdescription)
			parameters.description = getTranslatedMiscellaneous(language, parameters.entrydescription)
		else
